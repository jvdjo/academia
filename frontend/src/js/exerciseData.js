// Dados dos exercícios baseados no Guia Mestre de Hipertrofia
const exerciseData = {
    'Peitoral': { 
        'Superior (Clavicular)': [
    ...
    'Ombros': { 
        ...
        'Posterior (Traseira)': [
            ...
            'Crucifixo Inverso na Máquina (Pec-Deck Invertida)',
            'Face Pull',
    ...
    'Core': { 
        ...
        'Oblíquos': [
            'Prancha Lateral',
            'Rotação de Tronco na Polia (Woodchopper)',
